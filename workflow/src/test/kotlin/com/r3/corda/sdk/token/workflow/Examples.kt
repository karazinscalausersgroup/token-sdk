...
class Examples : LedgerTestWithPersistence() {
    ...
    fun `creating inlined token definition`() {
        ...
        val tenPoundsIssuedByIssuerOwnedByAlice: FungibleToken<FiatCurrency> = 10.GBP issuedBy ISSUER.party ownedBy ALICE.party
    ...
    fun `evolvable token definition`() {
        ...
        val houseIssuedByBobOwnedByAlice: NonFungibleToken<TokenPointer<House>> = houseIssuedByBob ownedBy ALICE.party

        // Now we want to do fractional ownership in this house...
        // Redeem the NonFungibleToken and reissue it as an FungibleToken
        val oneHundredUnitsOfHouse: FungibleToken<TokenPointer<House>> = 100 of housePointer issuedBy BOB.party ownedBy ALICE.party
    }
