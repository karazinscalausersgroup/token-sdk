 ...
 * [NonFungibleToken] or [FungibleToken] state it does not sub-class [Token].
 */
abstract class EvolvableTokenType : LinearState, TokenizableAssetInfo {
    /**
     * The [Party]s which create and maintain this token tokenType. It probably _is_ the issuer of the token but
     * may not necessarily be. For example, a reference data maintainer may create an [EvolvableTokenType] for
